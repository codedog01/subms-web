...
<div class="right">
     ...
     <div class="providerAdd">
         <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/WEB-INF/jsp/bill.do">
...
<script type="text/javascript" src="${pageContext.request.contextPath }/webapp/js/billadd.js"></script>